...
public class PlayerAnim : StateMachineBehaviour
{
    ...
    {
        GameObject.FindGameObjectWithTag("Parent").gameObject.GetComponent<Rigidbody2D>().constraints = RigidbodyConstraints2D.FreezePosition;
    }
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        GameObject.FindGameObjectWithTag("SceneCT").GetComponent<SceneCt>().LoadScene();
